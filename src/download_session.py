...
def _get_state(name):
    ...
    Checks ``src.download_data``'s own ``__dict__`` first (tests may set
    attributes there directly for backward compatibility), then falls
    back to this module's global.
    """
    import sys
